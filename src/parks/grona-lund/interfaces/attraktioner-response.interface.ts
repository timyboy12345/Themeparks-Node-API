  ...
  result: {
    data: {
        ...
        blocks: [
          {
            ...
            heroParagraph: null;
            buttonLabel: null;
            textPositioning: null;
            enableTextBackground: false;
            componentTheme: "blue";
            buttonLink: null;
            heroImageSmallDevice: {
              file: {
                url: "//images.ctfassets.net/ds6dz7ilx8up/6ip9AvSYBqFrpBA0AfrS0f/36ae3b5ce50207417b0b1c100b6c48be/attraktioner-hero-backgroundvideo-mobil.jpg";
              };
            };
            heroImageLargeDevice: {
              file: {
                url: "//images.ctfassets.net/ds6dz7ilx8up/5Bs4HgOsVfEGqypcVT1P72/688e9903225e2f922b53ecdc40b84a97/attraktioner-hero-backgroundvideo-desktop.jpg";
              };
            };
            backgroundVideo: {
              file: {
                url: "//videos.ctfassets.net/ds6dz7ilx8up/2s0k02ueulSxqzVmbUE52V/84dcbc5e8a31ba481007cc25dff70adc/1920x1080_header_attraktioner.mp4";
              };
            };
      ...
      contentfulSiteConfiguration: {
        ...
        facebookFallbackImage: {
          file: {
            url: "//images.ctfassets.net/ds6dz7ilx8up/2Lv4ATlfrPTBrKoH3JyAaV/beeac595fcb03faf12d81f09474eb2da/Gronalund-vy1080x720.jpg";
          };
        };
        footerLogo: {
          file: {
            url: "//images.ctfassets.net/ds6dz7ilx8up/XbI2on2RsCvDZYGJ0POYV/c7398c0165c1929a7821f4287787542b/grona-lund-logo.svg";
          };
        };
        footerLinks: Link[];
        ...
        footerParksAndResortsLink: {
          ...
          image: {
            file: {
              url: "//images.ctfassets.net/ds6dz7ilx8up/5LZe8u9WOigmEB8v7hj79H/14fd8c21cbc0ae6066d49b9a15cb0b2d/prs-logo-white.svg";
            };
          };
          asset: null;
          linkIcon: null;
        ...
        footerParksLinks: [
          {
            ...
            image: {
              file: {
                url: "//images.ctfassets.net/ds6dz7ilx8up/2tJY6HlaVQbEYVBXW8jXti/6de5f09e03c342ddfb86a13a5b65032a/kolmarden-logo.svg";
              };
            };
            asset: null;
            linkIcon: null;
          ...
          },
          {
            ...
            image: {
              file: {
                url: "//images.ctfassets.net/ds6dz7ilx8up/78My3M6ifkmayDnZDH5XwM/d96766841a56e6bc9d454d3082b8b884/furuvik-logo.svg";
              };
            };
            asset: null;
            linkIcon: null;
          ...
          },
          {
            ...
            image: {
              file: {
                url: "//images.ctfassets.net/ds6dz7ilx8up/2cfGfrjbqbgOnAkVCsQxcH/a24abd4d17418eaff5137c471a6c228c/skara-logo.svg";
              };
            };
            asset: null;
            linkIcon: null;
        ...
        broadcastMessageContent: {
          childMarkdownRemark: {
            html: "<p>Parken har öppet omsorgsfullt för ett begränsat antal gäster. Läs mer här.</p>";
          };
        };
        broadcastMessageLink: null;
        cookieMessageText: {
          childMarkdownRemark: {
            html: '<p>Vi använder sockervadd för att förbättra din upplevelse i vår park och cookies för att förbättra din upplevelse på vår webbsida. 🍪 Läs mer om hur vi behandlar dina personuppgifter <a href="https://parksandresorts.com/integritetspolicy/" title="Parks and Resorts Integritetspolicy">här</a>.</p>';
          };
        };
        ...
        edges: [
          {
            node: {
              ...
              templateImage: {
                file: {
                  url: "//images.ctfassets.net/ds6dz7ilx8up/1Di0OjHZPSPQAmJYvK8eiO/717def376977e8597a21d16f9197195b/star-emoji.png";
                };
              };
